...
SRCS = ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c \
	   ...
	   ft_strlcat.c ft_strcmp.c ft_strncmp.c ft_atoi.c \
	   ft_isalpha.c ft_isdigit.c ft_strncat.c ft_strchr.c \
	   ft_strrchr.c ft_strnstr.c ft_isalnum.c ft_isascii.c \
	   ...
	   ft_putnbr_fd.c ft_putendl.c ft_putendl_fd.c ft_itoa.c \
	   ft_lstnew.c ft_lstdelone.c ft_lstdel.c ft_lstadd.c \
	   ft_lstiter.c ft_lstmap.c ft_strstr.c ft_strlowcase.c \
	   ft_strupcase.c ft_strcapitalize.c ft_strrev.c \
	   ft_str_is_alpha.c ft_numdigits.c
